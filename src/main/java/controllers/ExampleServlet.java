...
public class ExampleServlet extends HttpServlet {
    ...
    protected void retrieveDatabaseInfo(Statement statement) {
        try {
            /*
                ...
                The following command is collecting all data from a table called models.Users
                where the column header is 'email'.
                Format: SELECT column_name, column_name... (or * for all columns) WHERE
                        column_name = value;
            */
            String email = "testemail@gmail.com";
            String sql = String.format("SELECT * FROM models.Users WHERE email = '%s';", email);
            /*
    ...
    protected void updateDatabaseInfo(Statement statement) {
        try {
            /*
                The following command updates an existing row of data in the table models.Users.
            ...
            */
            String sql = String.format("UPDATE models.Users SET lastName = '%s' WHERE firstName = '%s';", "Doe", "John");
            ...
            sql = String.format("INSERT INTO models.Users (email, password, firstName, lastName) VALUES ('%s', '%s', '%s', '%s');",
    ...
    protected void deleteDatabaseInfo(Statement statement) {
        try {
             ...
             */
            String sql = String.format("DELETE FROM models.Users WHERE firstName = '%s'", "Bella");
            statement.executeUpdate(sql);
        }
        catch (Exception e) {
            handleException(e);
